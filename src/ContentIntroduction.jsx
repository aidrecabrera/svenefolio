      ...
      <div className=" -mt-20 md:-mt-20 inset-0">
        <div className="flex items-center w-screen h-screen xl:leading-none">
          <h1 className=" z-10 pl-32 inherit  text-left text-10xl font-thin font-darker">
            <span className="duration-500 ease-in-out hover:font-bold ">WELCOME,</span>
            <br />
            <span className=" duration-500 ease-in-out hover:font-bold ">THIS</span>{" "}
            <span className=" duration-500 ease-in-out hover:font-bold ">IS</span>{" "}
